...
class CustomUser(AbstractUser):
    ...
    code_afiliation = models.CharField(max_length=50, blank=True,default=False)
    parrain = models.CharField(max_length=50, blank=True)
...
class Domaine(models.Model):
    nom_domaine = models.CharField(max_length=45, blank=True, null=True)
    def __str__(self):
...
class Cour(models.Model):
    ...
    categorieid = models.ForeignKey(Categorie, blank=True, null=True, on_delete=models.CASCADE,
                                  related_name='+', )
    domaineid = models.ForeignKey(Domaine, blank=True, null=True, on_delete=models.CASCADE,
                                    related_name='+', )


class Inscrit(models.Model):
    custom = models.ForeignKey(CustomUser, blank=True, null=True, on_delete=models.CASCADE,
                               related_name='+', )
    cour = models.ForeignKey(Cour, blank=True, null=True, on_delete=models.CASCADE,
                               related_name='+', )
    date_inscription = models.DateTimeField(blank=True, default=timezone.now)



class Commentaire(models.Model):
    titre_comment=models.CharField(max_length=45, blank=True, null=True)
    contenu_comment=models.CharField(max_length=255, blank=True, null=True)
    cour_comment = models.ForeignKey(Cour, blank=True, null=True, on_delete=models.CASCADE,
                                  related_name='+', )

class Chapitre(models.Model):
     nom_chapitre = models.CharField(max_length=200, blank=True, null=True)
     ordre = models.IntegerField(blank=True,null=True)
     prix_chapitre = models.FloatField(null=True, blank=True, default=None)
     objectif = models.CharField(max_length=255, blank=True, null=True)
...
class Check(models.Model):
    ...
    ntfin = models.BooleanField(default=0)
...
class Inscription(models.Model):
    ...
    cour = models.ForeignKey(Lesson, models.DO_NOTHING)
    users = models.ForeignKey(CustomUser, blank=True, null=True, on_delete=models.CASCADE,
                                    related_name='+', )
...
class ChargementOmoney(models.Model):
    users = models.ForeignKey(CustomUser, blank=True, null=True, on_delete=models.CASCADE,
                              related_name='+', )
    reference = models.CharField(max_length=200, blank=True, null=True)
    num_transfert = models.CharField(max_length=200, blank=True, null=True)
    montant = models.FloatField(null=True, blank=True, default=None)
    utilise = models.BooleanField(default=0)
    date = models.DateTimeField(blank=True, default=timezone.now)


class ServeurOrange(models.Model):
    reference = models.CharField(max_length=200, blank=True, null=True)
    num_transfert = models.CharField(max_length=200, blank=True, null=True)
    montant = models.FloatField(null=True, blank=True, default=None)
    date = models.DateTimeField(blank=True, default=timezone.now)
